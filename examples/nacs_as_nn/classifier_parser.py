...
parser.add_argument(
    "--no_vectorize_odeterm",
    action="store_true",
    help="Disable vectorization of ODE term. Should not be used. Only for comparison purposes.",
)
...
parser.add_argument(
    ...
    type=int,
    default=1,
    help="Downsample factor for images. Applied before quantization.",
)
...
parser.add_argument(
    "--data_image_downsample",
    type=int,
    default=1,
    help="Downsample factor for images (directly applied to the input images).",
)
