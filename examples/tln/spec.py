...
inpv2_v_mm = ProdRule(MmE, InpV, IdealV, DST,
                      EDGE.wt*(SRC.fn(TIME)-VAR(DST))/DST.c/SRC.r)
inpv2_i_mm = ProdRule(MmE, InpV, IdealI, DST,
                      EDGE.wt*(SRC.fn(TIME)-VAR(DST)*SRC.r)/DST.l)
inpi2_v_mm = ProdRule(MmE, InpI, IdealV, DST,
                      EDGE.wt*(SRC.fn(TIME)-VAR(DST)*SRC.g)/DST.c)
inpi2_i_mm = ProdRule(MmE, InpI, IdealI, DST,
