...
class Simulator:
    ...
    def spice_sim(self, file_name, data_points, temperature=25, nominal_temperature=25, step_time=1e-10, end_time=100e-9):
    ...
    def ds_sim(self, file_name, data_points, time_range=[0, 100e-9], n_time_points=1000):
